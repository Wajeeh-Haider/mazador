    ...
    public function paymentemail(Request $request) { 
        ...
        if($start == 0){
            ...
            try{
                ...
                return response()->json(['status'=>0,'message'=>' 000Something went wrong while sending email Please try again...'],200);
            } 
        ...
        return response()->json(['status'=>1,'message'=>'email sent'],200);
         }
}
