...
<head>
    ...
    <title>Mazador Website - Admin Verification</title>
    <!-- Favicon icon -->
                        ...
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form method="POST" class="mt-5 mb-5 login-input" action="{{ URL::to('auth') }}">
                                    ...
                                    <div class="form-group">
                                        <input id="purchase_key" type="text" class="form-control @error('purchase_key') is-invalid @enderror" name="purchase_key" autocomplete="current-purchase_key" placeholder="Purchase Key">
                                    ...
                                    <div class="form-group">
                                        <input id="domain" type="hidden" class="form-control @error('domain') is-invalid @enderror" name="domain" autocomplete="current-domain" value="{{url()->current()}}" placeholder="domain" readonly="">
                                    </div>
