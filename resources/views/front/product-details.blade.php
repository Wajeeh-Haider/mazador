...
<style>
    .ingredients-box:hover, .pro-box:hover, .product-details-img:hover, .btn:hover {
        ...
        <div class="row">
            ...
            <div class="col-lg-7 pro-details-display">
                ...
                <div class="pro-details-name-wrap">
                    ...
                    <input type="hidden" name="price" id="price" value="{{(float) $getitem->item_price}}">
                ...
                <div class="extra-food-wrap">
                    ...
                    <div class="pro-details-add-wrap">
                        ...
                        <p class="pricing">{{$getdata->currency}}{{number_format((float) $getitem->item_price, 2)}}</p>
                ...
                <h4 class="sec-head">Ingredients</h4>
                    ...
                    <!-- <div class="ingredients-carousel owl-carousel owl-theme"> -->
                        ...
                        <div class="col-8 col-sm-6 col-md-3">
                            <a data-fancybox="gallery" href="{{$ingredients->image }}">
