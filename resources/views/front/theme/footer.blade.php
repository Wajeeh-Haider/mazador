...
<style>
    .footer-socialmedia a:hover, .footer-logo:hover {
...
<footer>
	...
	<div class="copy-right text-center">
		...
		<!-- <p>{{$getabout->copyright}} <br> Designed & Developed by <a href="#" target="_blank" style="color: #000;"><b>Gravity Infotech</b>.</a></p> -->
		<p>{{$getabout->copyright}} <br> Designed & Developed by <a href="#" style="color: #000;"><b>Kaytech Soft.</b>.</a></p>
