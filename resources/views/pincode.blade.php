...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addPincode" data-whatever="@addPincode">Add Postcode</button>
        <!-- Add Pincode -->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Add New Postcode</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="pincode" class="col-form-label">Postcode:</label>
                            <input type="text" class="form-control" name="pincode" placeholder="Enter Postcode for available delivery" id="pincode">
                        </div>
                    </div>
        ...
        <div class="modal fade" id="EditPincode" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabeledit" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form method="post" name="editpincode" class="editpincode" id="editpincode">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabeledit">Edit Postcode</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <span id="emsg"></span>
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="getpincode" class="col-form-label">Postcode:</label>
                                <input type="text" class="form-control" name="pincode" placeholder="Enter Postcode for available delivery" id="getpincode">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">All Postcode</h4>
