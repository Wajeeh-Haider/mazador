            ...
            <div class="card">
                <div class="card-body" id="tab">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="example">
                                <h5 class="box-title m-t-30 mb-3">Select Date Range</h5>
                                ...
                                {{csrf_field()}}
                                    <div class="input-daterange input-group" id="date-range">
                                        ...
                                        <button type="button" class="btn mb-1 btn-block btn-info" onclick="GetReport()">Submit</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script type="text/javascript">
    var myApp = new function () {
        ...
        style = style + ".col-md-6 {display: none;}";
        style = style + "#color_cards {display: none;}";
        style = style + ".box-title {font: 27px Calibri;}";
        style = style + "</style>";
