...
<head>
    ...
    <title>Mazador Admin - Good Food for Everyone</title>
    <!-- Favicon icon -->
...
<body>
    ...
    ********************-->
    <div id="preloader">
        <div class="loader">
            <img src="{!! asset('public/front/images/loader.png') !!}" style="width: 80px;">
        </div>
    </div>
    <!--*******************
        Preloader end
    ********************-->
    ...
    <div id="main-wrapper">
                                  ...
                                  <div class="row">
                                      <div class="col-sm-3 col-md-6" style="display: none;">
                                          <div class="form-group">
                                              ...
                                              <input type="text" placeholder="Referral Amount" value="{{{Auth::user()->referral_amount}}}" class="form-control" name="referral_amount" id="referral_amount" disabled>
                                          </div>
                                      </div>
                                  ...
                                  <div class="row">
                                      <div class="col-sm-3 col-md-6">
                                          <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                  <input type="text" class="form-control" name="firebase" id="firebase" value="{{{Auth::user()->firebase}}}" disabled>
                                              </div>
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-sm-3 col-md-6">
                                          <div class="form-group">
                                              <label>Map Key: </label>
                                              <input type="text" class="form-control" name="map" id="map" value="{{{Auth::user()->map}}}" disabled>
                                          </div>
                                      </div>
                                  </div>
                              </div>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Designed & Developed by <a href="#">Intecht Soft.</a> 2022</p>
                <!-- <p>Copyright &copy; Designed & Developed by <a href="#" target="_blank">Gravity Infotech</a> 2020</p> -->
            </div>
        </div>
        <!--**********************************
            Footer end
