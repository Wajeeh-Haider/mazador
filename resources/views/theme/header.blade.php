...
<div class="nav-header" style="background-color: rgb(168, 0, 19);;">

    <div class="brand-logo">

        <a href="" style="text-decoration: none;">

            <b class="logo-abbr"><img style="border-radius: 50%;" src="{!! asset('public/assets/images/logo.png') !!}" alt=""> </b>

            <!-- <span class="logo-compact"><img src="{!! asset('public/assets/images/logo-compact.png') !!}" alt=""></span> -->

            <span class="brand-title" style="color: #ffff;">
