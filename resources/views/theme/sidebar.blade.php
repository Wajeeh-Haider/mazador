        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a href="{{URL::to('/admin/pincode')}}" aria-expanded="false">
                    <i class="fa fa-map-pin" aria-hidden="true"></i><span class="nav-text">Postcodes</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{URL::to('/admin/privacypolicy')}}">
                    <i class="fa fa-paperclip "></i><span class="nav-text">Privacy Policy</span>
                </a>
            </li>
            <li><a href="{{URL::to('/admin/termscondition')}}">
                <i class="fa fa-paperclip "></i><span class="nav-text">Terms & Conditions</span>
                </a>
            </li>
            <li><a href="{{URL::to('/admin/settings')}}">
                <i class="fa fa-cog"></i><span class="nav-text">About and Settings</span>
                </a>
            </li>
        </ul>
    </div>
